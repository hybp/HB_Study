...
## ZKP of Map Coloring Problems

Some logical problems with constraints, like sudoku, can be transformed into the map coloring problem. (NP Completeness)
![[Screenshot 2025-04-01 at 3.08.05 PM.png]]

And map coloring problem can be proved by ZKP
